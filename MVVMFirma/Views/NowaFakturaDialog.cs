...
{
    public class NowaFakturaDialog : Window
    {
        public NowaFakturaDialog()
        {
            Title = "Nowa faktura";
        ...
        {
            if (DataContext is NowaFakturaViewModel viewModel && viewModel.WasSaved)
            {
                DialogResult = true;
                return;
            }
