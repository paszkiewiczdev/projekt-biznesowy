...
{
    public class NowyAdresKontrahentaDialog : Window
    {
        public NowyAdresKontrahentaDialog()
        {
            Title = "Nowy adres kontrahenta";
        ...
        private UIElement BuildContent()
        {
            ...
            var form = new NowyAdresKontrahentaView();
        ...
        {
            if (DataContext is NowyAdresKontrahentaViewModel viewModel && viewModel.WasSaved)
            {
                DialogResult = true;
                return;
            }
