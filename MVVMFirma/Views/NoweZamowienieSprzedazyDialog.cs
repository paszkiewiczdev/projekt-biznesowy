...
{
    public class NoweZamowienieSprzedazyDialog : Window
    {
        public NoweZamowienieSprzedazyDialog()
        {
            Title = "Nowe zamówienie sprzedaży";
        ...
        private UIElement BuildContent()
        {
            ...
            var form = new NoweZamowienieSprzedazyView();
        ...
        {
            if (DataContext is NoweZamowienieSprzedazyViewModel viewModel && viewModel.WasSaved)
            {
                DialogResult = true;
                return;
            }
