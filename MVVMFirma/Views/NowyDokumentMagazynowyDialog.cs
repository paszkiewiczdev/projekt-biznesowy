...
{
    public class NowyDokumentMagazynowyDialog : Window
    {
        public NowyDokumentMagazynowyDialog()
        {
            Title = "Nowy dokument magazynowy";
        ...
        private UIElement BuildContent()
        {
            ...
            var form = new NowyDokumentMagazynowyView();
        ...
        {
            if (DataContext is NowyDokumentMagazynowyViewModel viewModel && viewModel.WasSaved)
            {
                DialogResult = true;
                return;
            }
