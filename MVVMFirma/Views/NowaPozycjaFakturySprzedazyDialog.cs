...
{
    public class NowaPozycjaFakturySprzedazyDialog : Window
    {
        public NowaPozycjaFakturySprzedazyDialog()
        {
        ...
        private UIElement BuildContent()
        {
            ...
            var form = new NowaPozycjaFakturySprzedazyView();
        ...
        {
            if (DataContext is NowaPozycjaFakturySprzedazyViewModel viewModel && viewModel.WasSaved)
            {
                DialogResult = true;
                return;
            }
