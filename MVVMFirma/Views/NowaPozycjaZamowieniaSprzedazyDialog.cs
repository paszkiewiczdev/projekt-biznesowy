...
{
    public class NowaPozycjaZamowieniaSprzedazyDialog : Window
    {
        public NowaPozycjaZamowieniaSprzedazyDialog()
        {
            Title = "Nowa pozycja zamówienia";
        ...
        private UIElement BuildContent()
        {
            ...
            var form = new NowaPozycjaZamowieniaSprzedazyView();
        ...
        {
            if (DataContext is NowaPozycjaZamowieniaSprzedazyViewModel viewModel && viewModel.WasSaved)
            {
                DialogResult = true;
                return;
            }
