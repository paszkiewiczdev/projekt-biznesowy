...
{
    public class NowyStanMagazynowyDialog : Window
    {
        public NowyStanMagazynowyDialog()
        {
            Title = "Nowy stan magazynowy";
        ...
        private UIElement BuildContent()
        {
            ...
            var form = new NowyStanMagazynowyView();
        ...
        {
            if (DataContext is NowyStanMagazynowyViewModel viewModel && viewModel.WasSaved)
            {
                DialogResult = true;
                return;
            }
